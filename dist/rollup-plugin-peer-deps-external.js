...
var moduleRegExp = function moduleRegExp(module) {
  return new RegExp("^" + module + "(\\/\\w+)*$");
};

var _require = require('path');
var resolve = _require.resolve;

function getPeerDeps() {
...
var resolve$1 = _require$1.resolve;

function getDeps() {
  var path = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : resolve$1(process.cwd(), 'package.json');
...
function PeerDepsExternalPlugin() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      doIncludeDeps = _ref.doIncludeDeps;

  var deps = getPeerDeps(packageJsonPath);
